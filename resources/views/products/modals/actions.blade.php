  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body d-flex justify-content-around">
        ...
        <a class="text-dark" href="{{ route('products.report.summary') }}"><i class="fas fa-3x fa-chart-line sel hvr-grow" data-toggle="tooltip" data-placement="bottom" title="@lang('products.titles.report')"></i></a>
