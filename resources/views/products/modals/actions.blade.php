  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body d-flex justify-content-around">
        ...
        <a class="text-dark" data-dismiss="modal" data-toggle="modal" data-target="#exportModal"><i class="fas fa-3x fa-download sel hvr-grow" data-toggle="tooltip" data-placement="bottom" title="Exportar productos"></i></a>
